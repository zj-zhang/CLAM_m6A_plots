...
def write_to_BED():
	...
	BED_formatter = "{chrom}\t{start}\t{end}\t{name}\t{avg_score}\t{strand}\t{exp}\t{rep}\t{score}\n"
	...
	#os.system('bedToBigBed -type=bed6+3 all_peak.sorted.bed ~/nobackup/programs/UCSC/hg19.chrom.sizes all_peak.sorted.bb')
